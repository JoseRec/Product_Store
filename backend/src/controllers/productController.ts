...
// Get products from user (protected - owner only)
export const getMyProducts = async (req: Request, res: Response) => {
  try {
    ...
    res.json(400).json({ error: "Failed to get user products" });
  }
};
...
export const getProductById = async (req: Request, res: Response) => {
  try {
    ...
    res.json(400).json({ error: "Failed to get product" });
  }
};
...
export const createProduct = async (req: Request, res: Response) => {
  try {
    ...
    res.json(400).json({ error: "Failed to create product" });
  }
};
